const Footer = () => {
  return (
    <div class="flex flex-col items-center px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div class="sm:col-span-2 text-center px-4 py-6">
          <a
            href="/"
            aria-label="Go home"
            title="Company"
          ...
          <div class="mt-6 lg:max-w-sm mx-auto">
        ...
        <div class="text-center">
          ...
          <p class="mt-4 text-sm text-gray-500">Reach out to us</p>
        </div>
      </div>
      <div class="flex flex-col-reverse items-center justify-between pt-5 pb-10 border-t lg:flex-row">
